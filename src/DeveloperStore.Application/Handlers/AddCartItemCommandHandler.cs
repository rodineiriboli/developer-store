...
namespace DeveloperStore.Application.Handlers
{
    public class AddCartItemCommandHandler : IRequestHandler<AddCartItemCommand, CartDto>
    {
        ...
        public AddCartItemCommandHandler(ICartRepository cartRepository, IUnitOfWork unitOfWork, IMapper mapper)
        {
        ...
        public async Task<CartDto> Handle(AddCartItemCommand request, CancellationToken cancellationToken)
        {
            ...
            cart.AddProduct(request.ItemDto.ProductId, request.ItemDto.Quantity);
